...
from handlers import start, game_menu, unknown_command, user_lk, pop_up_commands, search_engine, reviews, services_menu
...
async def start_params() -> None:
    ...
    dp.include_router(services_menu.router)
